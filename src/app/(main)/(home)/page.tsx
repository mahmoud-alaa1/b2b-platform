...
export const metadata: Metadata = {
  ...
  description: 'منصة B2B متطورة تربط الفنادق والمطاعم والمقاهي بموردين موثوقين. احصل على عروض أسعار فورية، وفّر حتى 40% من الوقت، وزيد كفاءة التوريد.',
  ...
  openGraph: {
    ...
    description: 'اكتشف آلاف الموردين الموثوقين، احصل على عروض أسعار تنافسية خلال دقائق',
    type: 'website',
    locale: 'ar_EG',
