...
import { ArrowRight, BarChart3, CheckCircle, Clock, DollarSign, Globe, Package, Shield, TrendingUp, Users } from "lucide-react";
...
function ValuePropositionTabContent({ benefit }: {
    benefit: {
            ...
            <Card className="bg-white/80 backdrop-blur-sm border border-white/50 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                <CardContent className="p-6 text-center">
                    ...
                    <div className="relative mb-6">
                        <div className={`w-16 h-16 bg-gradient-to-r ${benefit.color} rounded-2xl flex items-center justify-center mb-4 mx-auto shadow-lg`}>
