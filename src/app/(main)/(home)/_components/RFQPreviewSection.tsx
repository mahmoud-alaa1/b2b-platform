...
export default function RFQPreviewSection() {
    ...
    const [displayedSuppliers, setDisplayedSuppliers] = useState<typeof mockSuppliers>([]);
                    ...
                    >
                        <div className="relative">
                            <div className="relative">
                                ...
                                />
                                <Button
                                    className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-6 py-3 rounded-xl"
                                >
                                    بحث
                                </Button>
                            </div>
