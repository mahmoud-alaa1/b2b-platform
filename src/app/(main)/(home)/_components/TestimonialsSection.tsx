...
const testimonials = [
    {
        ...
        rating: 5,
        content: "SupplyFi غيّر طريقة عملنا بالكامل. وفرنا 40% من الوقت و 25% من التكاليف. الموردون موثوقون والخدمة ممتازة.",
        metrics: {
            timeSaved: "40%",
            costSaved: "25%",
    ...
    },
    {
        ...
        avatar: "/api/placeholder/64/64",
        rating: 5,
        content: "كمطعم صغير، كان صعب علينا نحصل على أسعار تنافسية. SupplyFi ساعدنا نوصل لموردين ما كنا نعرفهم وحسّن هوامش ربحنا.",
        metrics: {
            timeSaved: "60%",
            costSaved: "30%",
    ...
    },
    {
        ...
        avatar: "/api/placeholder/64/64",
        rating: 5,
        content: "المنصة سهلة الاستخدام والدعم الفني رائع. حصلنا على عروض أسعار من 5 موردين خلال ساعة واحدة فقط.",
        metrics: {
            timeSaved: "50%",
            costSaved: "20%",
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                        اكتشف كيف ساعدت SupplyFi مئات الشركات في تحسين عمليات التوريد وزيادة الأرباح
                    </p>
                </motion.div>
