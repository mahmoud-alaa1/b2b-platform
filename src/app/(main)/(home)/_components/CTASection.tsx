            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <div
                        ...
                        className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium text-white mb-8 border border-white/30"
                    >
                    ...
                    <h2
                        ...
                        className="text-4xl md:text-6xl font-bold text-white leading-24 mb-6"
                    >
                    ...
                    >
                        انضم لآلاف الشركات التي تستخدم SupplyFi وابدأ في توفير الوقت والمال من أول طلب
                    </p>
                    ...
                    >
                        {stats.map((stat, index) => (
                            ...
                            >
                                ...
                                <p className="text-indigo-100 font-medium text-center">{stat.label}</p>
                            </div>
                        ))}
                    </div>
                </div>
