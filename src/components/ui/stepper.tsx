...
function StepperIndicator({
  ...
  return (
    <span
      ...
      className={cn(
        "bg-indigo-300 text-white  data-[state=active]:bg-primary data-[state=completed]:bg-primary data-[state=active]:text-primary-foreground data-[state=completed]:text-primary-foreground relative flex size-6 shrink-0 items-center justify-center rounded-full text-xs font-medium",
        className
      )}
      data-state={state}
      {...props}
