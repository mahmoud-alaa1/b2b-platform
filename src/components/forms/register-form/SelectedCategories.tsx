...
const getCategoryNameById = (categoryId: string | number, allCategories: ICategory[]): string => {
...
export default function SelectedCategories() {
    ...
    const cachedCats = queryClient.getQueryData<InfiniteData<IPaginatedResponse<ICategory>>>(['categories']);
    const allCategories = cachedCats?.pages.flatMap(page => page.data) ?? [];
