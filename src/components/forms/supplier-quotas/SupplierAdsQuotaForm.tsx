...
import { Megaphone, SendIcon } from "lucide-react";
...
import usePostSupplierAdsQuota from "@/hooks/quotas/usePostSupplierAdsQuota";

export default function SupplierAdsQuotaForm() {
  ...
  const { mutate: postAds, isPending } = usePostSupplierAdsQuota();
