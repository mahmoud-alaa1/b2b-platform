            ...
            >
              ...
              >
                ...
                <CardContent className="p-0">
                  {/* Header */}
                  <div
                    className={`bg-gradient-to-br ${plan.bgColor} p-8 border-b border-slate-100`}
                  >
                    <div className="flex items-center gap-3 mb-4">
                      <div
                        className={`w-12 h-12 bg-gradient-to-r ${plan.color} rounded-xl flex items-center justify-center shadow-lg`}
                      >
